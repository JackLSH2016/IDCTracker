...
-(void)setGrade:(float)grade
{
    ...
    NSLog(@"-----%@",NSStringFromCGPoint(CGPointMake(self.frame.size.width/2.0, self.frame.size.height)));
    [progressline addLineToPoint:CGPointMake(self.frame.size.width/2.0, (1 - grade) * self.frame.size.height)];
      NSLog(@"-----%@",NSStringFromCGPoint(CGPointMake(self.frame.size.width/2.0,(1 - grade) * self.frame.size.height)));
